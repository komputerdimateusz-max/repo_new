...
def test_restaurant_location_request_submit_and_review(tmp_path: Path, monkeypatch) -> None:
    ...
    with TestClient(app) as client:
        ...
        create_response = client.post(
            ...
            data={"company_name": "New Co", "address": "Road 9", "notes": "new warehouse"},
...
def test_restaurant_coverage_filters_hide_legacy_until_inactive_enabled(tmp_path: Path, monkeypatch) -> None:
    ...
    try:
        ...
        active_location = Location(company_name="Active Co", address="Main 1", is_active=True, cutoff_time=time(10, 0))
        legacy_location = Location(company_name="Legacy Location", address="Unknown Address", is_active=False, cutoff_time=time(9, 0))
