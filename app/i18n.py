...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "coverage.served_postal_codes": "Served postal codes",
        "coverage.manage_postal_codes": "Manage postal codes",
        "coverage.postal_codes_subtitle": "Add and activate postal codes your restaurant serves.",
        "coverage.add_postal_code": "Add postal code",
        "coverage.add": "Add",
        "coverage.activate": "Activate",
        "coverage.deactivate": "Deactivate",
        "coverage.add_location": "Add company/location",
        "coverage.select_postal_code": "Select postal code",
        "coverage.add_location_submit": "Add",
        "coverage.no_served_postal_codes": "No active postal codes configured.",
        "coverage.add_postal_code_first": "Najpierw dodaj obsługiwany kod pocztowy.",
        "coverage.error.postal_code_not_served": "Postal code is not within your active coverage.",
        "coverage.remove": "Remove",
        "coverage.remove.success": "Location removed from delivery coverage.",
        "coverage.show_inactive": "Show inactive",
    ...
    "pl": {
        ...
        "coverage.served_postal_codes": "Obsługiwane kody pocztowe",
        "coverage.manage_postal_codes": "Zarządzaj kodami pocztowymi",
        "coverage.postal_codes_subtitle": "Dodaj i aktywuj kody pocztowe obsługiwane przez restaurację.",
        "coverage.add_postal_code": "Dodaj kod pocztowy",
        "coverage.add": "Dodaj",
        "coverage.activate": "Aktywuj",
        "coverage.deactivate": "Dezaktywuj",
        "coverage.add_location": "Dodaj firmę/lokalizację",
        "coverage.select_postal_code": "Wybierz kod pocztowy",
        "coverage.add_location_submit": "Dodaj",
        "coverage.no_served_postal_codes": "Brak aktywnych kodów pocztowych.",
        "coverage.add_postal_code_first": "Najpierw dodaj obsługiwany kod pocztowy.",
        "coverage.error.postal_code_not_served": "Kod pocztowy nie należy do aktywnie obsługiwanych.",
        "coverage.remove": "Usuń",
        "coverage.remove.success": "Usunięto lokalizację z obsługiwanych.",
        "coverage.show_inactive": "Pokaż nieaktywne",
